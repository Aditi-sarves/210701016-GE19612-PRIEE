...
<head>
	...
	<title>CAREERQUEST - <?php echo "$title"; ?></title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employees.php">students login</a>
							</li>
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">View This INTERNSHIP</a>
													</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>CAREERQUEST is a dynamic INTERNSHIP board or portal built with PHP for seamless internship posting, searching, and candidate management.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Internship</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">careerquest@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> CAREERQUEST Vision Software</p>
