...
<head>
	...
	<title>CAREERQUEST - Contact Us</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">ADMIN</a>
							</li>
							
							<li>
								<a href="employees.php">STUDENT</a>
							</li>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> NO 25 <br/>MOUNT ROAD, CHENNAI. </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">jobboard@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About JOBBOARD</h5>
											<p>JOBBOARD is a dynamic job board or portal built with PHP for seamless job posting, searching, and candidate management.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">JOBBOARD Contact</h5>
								
								<p>Address : NO 25, Mount Road, Chennai</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">jobboard@gmail.com</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by JOBBOARD</a></li>
								</ul>
