...
<head>
	...
	<title>CAREERQUEST - Employers</title>
						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title">ADMIN</h3>
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>CAREERQUEST is a dynamic job board or portal built with PHP for seamless job posting, searching, and candidate management.</p>
