...
<body class="home">
	...
	<div class="container-wrapper">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">ADMIN LOGIN</a>
							</li>
							
							<li>
								<a href="employees.php">STUDENT LOGIN</a>
							</li>
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as STUDENT</a>
						</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
				<div class="container">

					<h1>Your bright future starts here now</h1>
					<p>Finding your next internships/workshops on CAREER QUEST</p>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5>02 / Apply for an internship</h5>
									</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About CAREERQUEST</h5>
											<p> CAREERQUEST is a dynamic internship/workshop portal built with PHP for seamless internship posting, searching, and candidate management.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Admin</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">CAREERQUEST Contact</h5>
								
								<p>Address : NO 25, Mount Road, Chennai</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">careerquestgmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> JOBBOARD Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by CAREERQUEST</a></li>
								</ul>
